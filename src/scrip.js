...
//meter todo lo que se va a cargar antes de iniciar el juego
function preload() {
...
//para ver como se mueve el jugador 
function update() {
...
bomb.setVelocity(Phaser.Math.Between(-5000, 5000), 20);
}
